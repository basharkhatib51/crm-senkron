    ...
    <b-row>
      <b-col cols="6">
        <b-button
          ...
          @click="$router.push({name:'slider.create'})"
        >
          {{ $t('Create new') }}
        </b-button>
      </b-col>
      ...
      >
        <b-button
          ...
          @click="$router.push({name:'slider.trashed'})"
        >
          <font-awesome-icon
            :icon="['fas', 'trash']"
          />
        ...
        >
          ...
          <template #cell(options)="data">
            <div class="w-max">
              <router-link
                class="text-success"
                :to="{name:'slider.edit',params: { slider: data.item.id }}"
              >
                <font-awesome-icon
                  :icon="['fas', 'edit']"
                />
...
export default {
  ...
  methods: {
    ...
    ConfirmDelete() {
      this.$store.dispatch('slider/Delete', this.element)
    },
  },
}
</script>
