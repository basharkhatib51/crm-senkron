    ...
    >
      ...
      >
        ...
        >
          ...
          <template #cell(children_menus_count)="data">
            <b-badge
              pill
              :variant="data.item.children_menus.length>0?'light-success':'light-warning'"
            >
              {{ data.item.children_menus.length }}
            </b-badge>
          </template>
          <template #cell(parent_menu)="data">
            <b-badge
              pill
              :variant="data.item.parent_menu?'light-success':'light-warning'"
            >
              {{ data.item.parent_menu?data.item.parent_menu.name:'parent' }}
            </b-badge>
          </template>
  ...
  computed: {
    fields() {
      return [
        ...
        { key: 'parent_menu', label: this.$t('parent_menu') },
        { key: 'children_menus_count', label: this.$t('children_menus_count') },
